	...
	<body>
		...
		<?php
			...
			if($passport && count($suitcase) < 4) {
				...
				echo "<p>My suitcase contains " . $suitcase[0] . ", " . $suitcase[1] . ", " . $suitcase[2] . ", " . $suitcase[3] . ", " . $suitcase[4] . " and I am going on holiday.</p>";
			}
				...
				echo "<p>My suitcase contains " . $suitcase[0] . ", " . $suitcase[1] . ", " . $suitcase[2] . ", " . $suitcase[3] . " but I am staying at home.</p>";
			}
			else {     // or else if(count($suitcase) >= 4) {
				// You have 4 or more items in your suitcase
				array_splice($suitcase, 0, 1); 
				echo "<p>My suitcase contains " . $suitcase[0] . ", " . $suitcase[1] . ", " . $suitcase[2] . ".</p>";
			}
